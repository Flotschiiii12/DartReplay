...
def get_latest_visit():
    ...
    with engine.connect() as connection:
        ...
        for throw in throws[1:]:
            ...
            newer = parse_time(
                visit[-1].detection_time
            )

            current = parse_time(
                throw.detection_time
            )
...
def get_latest_180_timeline():
    ...
    return {
        ...
        "throw_2": str(throw_2),
        "throw_3": str(throw_3),
        "sector_1": throws[0].sector,
        "sector_2": throws[1].sector,
        "sector_3": throws[2].sector,
        "delta_1": delta_1,
        "delta_2": delta_2,
